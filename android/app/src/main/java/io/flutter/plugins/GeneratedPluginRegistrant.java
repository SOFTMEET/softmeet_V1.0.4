...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.cleveroad.cr_file_saver.CrFileSaverPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin cr_file_saver, com.cleveroad.cr_file_saver.CrFileSaverPlugin", e);
    }
    try {
